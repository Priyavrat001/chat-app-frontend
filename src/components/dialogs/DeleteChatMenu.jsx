...
const DeleteChatMenu = ({ dispatch, deleteMenuAnchor }) => {
    ...
    const [deleteChat, _, deleteChatData] = useAsyncMution(useDeleteChatMutation);
    
    const [leaveGroup, __, leaveGroupData] = useAsyncMution(useLeaveGroupMutation);
  ...
  if(deleteChatData || leaveGroup) navigate("/");
    ...
    return (
        ...
        >
            ...
            >
                {
                    isGroup?<><ExitToAppIcon/>
                    <Typography>Leave Group</Typography>
                    </>:<><DeleteIcon/>
                    <Typography>Delete Chats</Typography>
                    </>
                }
            </Stack>
